             ...
             <ul class="nav nav-stacked">
                <li class="nav-header"> <a href="#" data-toggle="collapse" data-target="#userMenu">My Project <i class="glyphicon glyphicon-chevron-down"></i></a>
                    <ul class="nav nav-stacked collapse in" id="userMenu">
                        ...
                        <li><a href="adminview.jsp"><i class="glyphicon glyphicon-envelope"></i> view  <span class="badge badge-info">4</span></a></li>
                    ...
                    res=stat.executeQuery(data);
                       while(res.next())
                       {
                          ...
                          <td><%=res.getString("workersname")%></td>
                           <td>
                              <a href='adminviewpro.jsp?u=<%=res.getInt("contact_id")%>' class="btn btn-warning">View</a>
                              <a href='deletepro.jsp?d=<%=res.getInt("contact_id")%>' class="btn btn-danger">Delete</a>
                          </td>
                          </tr>
                          <%
                       }
